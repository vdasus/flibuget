...
/// <summary>
/// Perplexity AI implementation of the AI provider
/// </summary>
public class PerplexityProvider : IAIProvider
{
  ...
  ILogger<PerplexityProvider> logger)
      ...
      CancellationToken cancellationToken = default)
    {
        ...
        // Convert generic request to Perplexity format
        ...
        _logger.LogInformation("Sending chat completion request to Perplexity API with model {Model}",
      perplexityRequest.Model);
        ...
        // Convert Perplexity response to generic format
        var result = new AIChatCompletionResponse
        {
