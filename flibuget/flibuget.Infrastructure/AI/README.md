...
### Implementations (flibuget.Infrastructure)
...
private static AIProviderConfig? ConfigureAnthropic(IConfiguration configuration)
{
    ...
    return new AIProviderConfig
    {
        ...
        ApiKey = apiKey,
        DefaultModel = configuration["Anthropic:DefaultModel"] ?? "claude-opus-4-7",
...
See `flibuget.Infrastructure\Examples\AIServiceUsageExample.cs` for comprehensive usage examples including:
- Simple questions
...
- `Microsoft.Extensions.Logging` (v10.0.7) - Logging support
- `Microsoft.Extensions.Configuration` (v10.0.7) - Configuration support
- `Microsoft.Extensions.Http` (v10.0.7) - HTTP client factory
